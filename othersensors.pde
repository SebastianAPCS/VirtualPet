...
void draw() {
    ...
    System.out.println("left button value" + leftButton);
    System.out.println("right button value" + rightButton);
    ...
    if (leftButton == 1023) {
        ...
        redraw();
        updateTransform();
    } else if (rightButton == 1023) {
        angles[0] -= 2;
        angles[1] -= 1;
        redraw();
        updateTransform();
    } else if ((rightButton == 1023) & (leftButton == 1023)) {
        redraw();
        updateTransform();
    }
